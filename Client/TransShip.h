...
private:
	...
	list<const TEXINFO*>		m_TransTexlist;
public:
	list<const TEXINFO*>*		GetTransTex();
public:
...
public:
	CTransShip(void);
	CTransShip(D3DXVECTOR3 _vPos, D3DXVECTOR3 _vWayPos, eUnitType _Type, ePlayerType _TeamType, BYTE _byDrawID)
	{
		m_tInfo.vPos = _vPos;
		...
		m_tInfo.m_eUnitType = UT_TRANSSHIP;
		...
		m_tInfo.wstrObjKey = L"TransShip";
