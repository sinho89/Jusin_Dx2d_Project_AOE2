...
public:
	CGallyShip(void);
	CGallyShip(D3DXVECTOR3 _vPos, D3DXVECTOR3 _vWayPos, eUnitType _Type, ePlayerType _TeamType, BYTE _byDrawID)
	{
		m_tInfo.vPos = _vPos;
		...
		m_tInfo.m_eUnitType = UT_GALLYSHIP;
		...
		m_tInfo.wstrObjKey = L"GallyShip";
